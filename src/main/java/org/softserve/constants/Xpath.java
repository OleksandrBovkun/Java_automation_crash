...
public class Xpath {
    ...
    public interface WomanTab{
        String
                ...
                DETAILS_TAB = "//a[@id='tab-label-description-title' and contains(text(), 'Details')]",
                DETAILS_CONTENT = "//div[@class='data item content' and @id='description']",
                MORE_INFO_TAB = "//a[@id='tab-label-additional-title' and contains(text(), 'More Information')]",
                MORE_INFO_CONTENT = "//div[@class='data item content' and @id='additional']",
                REVIEWS_TAB = "//a[@id='tab-label-reviews-title' and contains(text(), 'Reviews')]",
